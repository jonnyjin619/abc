...
static int      Mini_AigLitNot( int Lit )                      {
		int litNot = Lit ^ 1;
#ifdef SHOW_DEV_MSG
		//printf("\tNot\tIn[%d]\tOut[%d]\tVarIn[%d]\tVarOut[%d]\n", Lit, litNot, Abc_Lit2Var(Lit), Abc_Lit2Var(litNot));
		printf("\tNot\tFaninLit: [%d]\tFanoutLit: [%d]\n", Lit, litNot);
#endif
...
#ifdef SHOW_DEV_MSG
		//printf("\tConst0\tIn[]\tOut[0]\tVarIn[]\tVarOut[%d]\n", Abc_Lit2Var(0));
		printf("\tConst0\tFaninLit: []\tFanoutLit: [0]\n");
#endif
	return 0;
}
...
#ifdef SHOW_DEV_MSG
		//printf("\tConst1\tIn[]\tOut[1]\tVarIn[]\tVarOut[%d]\n", Abc_Lit2Var(1));
	    printf("\tConst1\tFaninLit: []\tFanoutLit: [1]\n");
#endif
	return 1;
}
...
#ifdef SHOW_DEV_MSG
    //printf("\tPI\tIn[]\tOut[%d]\tVarIn[]\tVarOut[%d]\n",
    //		Lit, Abc_Lit2Var(Lit));
    printf("\tFaninLit: []\tFanoutLit: [%d]\n", Lit);
#endif
...
#ifdef SHOW_DEV_MSG
    //printf("\tPO\tIn[%d]\tOut[%d]\tVarIn[%d]\tVarOut[%d]\n",
    //		Lit0, Lit, Abc_Lit2Var(Lit0), Abc_Lit2Var(Lit));
    printf("\tFaninLit: [%d]\tFanoutLit: [%d]\n", Lit0, Lit);
#endif
...
#ifdef SHOW_DEV_MSG
		//printf("\tAnd\tIn[%d,%d]\tOut[%d]\tVarIn[%d,%d]\tVarOut[%d]\n",
		//		Lit0, Lit1, Lit, Abc_Lit2Var(Lit0), Abc_Lit2Var(Lit1), Abc_Lit2Var(Lit));
		printf("\tAnd\tFaninLit: [%d,%d]\tFanoutLit: [%d]\n", Lit0, Lit1, Lit);
#endif
